...
#
from dtos.requests.apis.fetch.account import FetchAccountRequestDTO
#
...
#
from services.apis.fetch.account import FetchAccountService
#
from utilities.dictionary import DictionaryUtility


class FetchAccountController(IController):
    ...
    # GET method to handle fetching account details
    async def get(self, request: Request, request_payload: FetchAccountRequestDTO):
        ...
        try:
            ...
            response_dto: BaseResponseDTO = await FetchAccountService(
